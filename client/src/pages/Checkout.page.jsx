...
const Checkout = () => {
  ...
  const restaurants = useSelector((globalState) => globalState.restaurant.selectedRestaurant.restaurants);
    ...
    <div className="my-3 flex flex-col gap-3 items-center">
      ...
      <div className="w-full md:w-3/5 rounded-lg py-3 drop-shadow-2xl bg-white flex flex-col items-center p-4">
        ...
        <div className="flex w-full flex-col gap-2 items-center">
          ...
          <div>
            <h4>
              ₹ {cart.reduce((acc, curVal) => acc + parseInt(curVal.totalPrice), 0)}{" "}
              <sub>(plus tax)</sub>
            </h4>
          </div>
